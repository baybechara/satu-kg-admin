      ...
      <div className="max-w-[820px] w-full mx-auto bg-neutral-50 min-h-screen flex flex-col justify-between auth-padding pt-14 pb-10 shadow-2xl">
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-2">
            <h1 className="text-[32px] font-bold text-text-primary">Войдите в аккаунт</h1>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between mt-1 px-1">
                <label className="flex items-center gap-3 cursor-pointer" onClick={() => setRememberMe(!rememberMe)}>
                  ...
                  <span className="text-[15px] text-neutral-500">Запомнить меня</span>
                </label>
                <button className="text-[15px] text-neutral-500 hover:text-text-primary transition-colors">
                  Забыли пароль?
                </button>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-4 mt-12">
          ...
          <div className="flex flex-col items-center justify-center gap-1 mt-6">
            <span className="text-neutral-500 text-[15px]">Нет аккаунта?</span>
            <button 
