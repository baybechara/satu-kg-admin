    ...
    <div className="min-h-screen flex flex-col items-center bg-neutral-100">
      <div className="max-w-[820px] w-full mx-auto bg-white min-h-screen flex flex-col items-center justify-center relative shadow-2xl animate-fade-in">
        ...
        <div className="absolute bottom-12 flex flex-col items-center gap-4">
          <div className="w-8 h-8 border-4 border-neutral-100 border-t-[#2D2D2D] rounded-full animate-spin"></div>
          <p className="text-[14px] text-neutral-500 font-['Open_Sans']">Загрузка...</p>
        </div>
      </div>
    </div>
  )
